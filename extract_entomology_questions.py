"""
수목해충학 5~11회 전체 기출문제를 JSON으로 추출.
EC2에서 실행: python extract_entomology_questions.py
"""
...
subject = Subject.objects.get(name__contains="수목해충")
...
out_path = os.path.join(os.path.dirname(__file__), "entomology_questions.json")
