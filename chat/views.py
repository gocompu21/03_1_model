...
2. 번호 매기기:
   - 대분류: ### 소제목 형식
   - 항목 나열: 1. 2. 3. (마크다운 ordered list)
   - 각 항목은 한 줄로 작성 (줄바꿈 최소화)
...
### 2. 세로맥의 종류
1. **전연맥 (Costa, C)**: 날개의 맨 앞쪽 가장자리를 따라 흐르며 대개 분지되지 않는 단순한 형태입니다.

2. **아전연맥 (Subcosta, Sc)**: 전연맥 바로 뒤에 평행하게 위치하며 보통 끝부분에서 두 갈래로 갈라집니다.

3. **경맥 (Radius, R)**: 날개에서 가장 강력하고 중요한 맥입니다.
