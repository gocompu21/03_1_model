# -*- coding: utf-8 -*-
"""
수목관리학 용어 설명 JSON을 DB에 적용하는 스크립트

사용법:
  python apply_management_explanations.py                    # 대화형 모드
  python apply_management_explanations.py --auto             # 자동 모드
  python apply_management_explanations.py --file custom.json # 다른 파일 지정
"""
import os
import sys
import json
...
def main():
    print("=== 수목관리학 용어 설명 DB 적용 ===")

    # 파일 경로 설정
    input_file = "management_explanations.json"
